...
class SellerHomePage extends StatefulWidget {
  ...
  const SellerHomePage({Key? key, required this.categoryName}) : super(key: key);
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        children: [
                          Text(
                            (summarDto?.totalRequestServed?.toString() ?? '0'), // Default to '0' if null
                    ...
                    Expanded(
                      child: Column(
                        children: [
                          Text(
                            (summarDto?.overAllRating?.toStringAsFixed(1) ?? '0.0'), // Default to '0.0' if null
                            textAlign: TextAlign.center,
                            style: const TextStyle(
                              fontSize: 40,
                              color: Colors.blue,
