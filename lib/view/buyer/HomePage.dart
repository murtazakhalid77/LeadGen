          ...
          Container(
            ...
            child: Container(
              ...
              child: GridView.count(
                ...
                mainAxisSpacing: 30,
                children: [
                  itemDashboard('Vehicles', CupertinoIcons.car, Colors.deepOrange),
                  itemDashboard('Bikes', CupertinoIcons.add_circled, Colors.green),
                  ...
                  itemDashboard('Kids', CupertinoIcons.chat_bubble_2, Colors.brown),
                  itemDashboard('Fashion & \nAccessories', CupertinoIcons.money_dollar_circle, Colors.indigo),
                  itemDashboard('Hobbies', CupertinoIcons.guitars, Colors.teal),
                  itemDashboard('Books', CupertinoIcons.book, Colors.blue),
                  itemDashboard('Animals', CupertinoIcons.phone, Colors.pinkAccent),
                ],
              ),
            ),
          ),
